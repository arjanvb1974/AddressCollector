...
namespace AddressCollector.Migrations
{
    ...
    [Migration("20200228135836_EditAppUser1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AddressCollector.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("AddressCollector.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("AddressCollector.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("AddressCollector.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AddressCollector.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("AddressCollector.Models.OrderDetail", b =>
                {
                    b.HasOne("AddressCollector.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AddressCollector.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AddressCollector.Models.Pie", b =>
                {
                    b.HasOne("AddressCollector.Models.Category", "Category")
                        .WithMany("Pies")
